...
class MenuViewController: UIViewController {
    ...
    private lazy var puppediaButton = UIButton.outlinedButton(title: "My Puppedia", image: UIImage(systemName: "book.fill")?.withRenderingMode(.alwaysTemplate))
    private lazy var hiscoreButton = UIButton.outlinedButton(title: "Hi-score", image: UIImage(systemName: "trophy.fill")?.withRenderingMode(.alwaysTemplate))
